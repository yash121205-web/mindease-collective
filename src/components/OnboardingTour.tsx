...
const steps = [
  { icon: Sparkles, emoji: '👋', title: 'Welcome to MindEase AI!', desc: 'Your AI-powered mental wellness companion. Let me show you around in 30 seconds.', gradient: 'from-primary/20 via-secondary/10 to-accent/15' },
  { icon: MessageCircle, emoji: '💬', title: 'Chat with SERA', desc: 'Your empathetic AI companion. Share what\'s on your mind — SERA listens without judgment and supports you in 90+ languages.', gradient: 'from-primary/20 to-primary/5' },
  { icon: Smile, emoji: '😊', title: 'Mood Tracking', desc: 'Log your daily mood with a quick emoji check-in. Track emotional patterns and get burnout warnings.', gradient: 'from-accent/20 to-accent/5' },
  { icon: BookOpen, emoji: '📓', title: 'AI-Powered Journal', desc: 'Write freely and get gentle AI reflections. Includes gratitude tracking and emotional tone analysis.', gradient: 'from-secondary/20 to-secondary/5' },
  { icon: Wind, emoji: '🧘', title: 'Wellness Exercises', desc: 'Guided breathing, body scans, grounding techniques, focus timers, and AI-generated wellness plans.', gradient: 'from-rose-soft/30 to-rose-soft/5' },
  { icon: BarChart3, emoji: '📊', title: 'Insights Dashboard', desc: 'Emotion heatmaps, mood trends, word clouds, stress patterns, and weekly AI-generated narrative insights.', gradient: 'from-primary/15 to-secondary/10' },
  { icon: Target, emoji: '🎯', title: 'Challenges & Progress', desc: 'Complete wellness challenges, build streaks, earn badges, and track your growth with habit grids.', gradient: 'from-accent/20 to-primary/10' },
  { icon: Moon, emoji: '😴', title: 'Sleep & Diet Tracking', desc: 'Log sleep quality, meals, water intake — and get AI-powered nutrition and sleep insights.', gradient: 'from-secondary/20 to-accent/10' },
];
...
const contentVariants = {
  enter: (dir: number) => ({ x: dir > 0 ? 80 : -80, opacity: 0, scale: 0.92, filter: 'blur(4px)' }),
  center: { x: 0, opacity: 1, scale: 1, filter: 'blur(0px)' },
  exit: (dir: number) => ({ x: dir > 0 ? -80 : 80, opacity: 0, scale: 0.92, filter: 'blur(4px)' }),
};
    ...
    >
      ...
      <div className="relative w-full max-w-[380px]">
        ...
        <motion.div
          ...
          className="absolute inset-0 -m-6 rounded-[2.5rem] bg-gradient-to-br from-primary/15 via-secondary/10 to-accent/15 blur-3xl"
        />
          ...
          >
            ...
            <div className="relative z-10 p-8 pt-7">
              ...
              <motion.h2
                ...
                className="font-display text-xl text-foreground text-center mb-2"
              >
                {current.title}
              </motion.h2>
